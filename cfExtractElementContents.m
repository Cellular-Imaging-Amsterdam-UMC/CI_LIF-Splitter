function elementsContent = cfExtractElementContents(xmlString)
    ...
    % Get all <Element> nodes under the first <Children>
    elementNodes = childrenNode.getElementsByTagName('Element');
